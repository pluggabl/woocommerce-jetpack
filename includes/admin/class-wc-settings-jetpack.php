       ...
       public function output_cats_submenu(){
         ...
         public function output()
        {
            ...
            if (isset(w_c_j()->modules[$current_section]->dev) && true === w_c_j()->modules[$current_section]->dev) {
                ...
                echo '<p>';
                echo '<strong>';
                echo sprintf(__('Please note that <em>%s</em> module is currently under development. Until stable module version is released, options can be changed or some options can be moved to paid plugin version.', 'woocommerce-jetpack'), w_c_j()->modules[$current_section]->short_desc);
                echo '</strong>';
                echo '</p>';
                echo '</div>';
            }
                ...
                <div class="wcj-body-parts wcj-body-right">
                  ...
                  <div class="wcj-partitions updates-section">
                    ...
                    <div class="wcj-partitions-sub-dtl">
                      <h6><?php _e('Version ', 'woocommerce-jetpack');?><?php echo w_c_j()->version; ?></h6>
