...
//			array( 'code' => 'KIP', 'name' => __( 'Lao kip', 'woocommerce-jetpack' ),                                    'symbol' => 'KIP', ),
		...
		// as in WooCommerce v2.5.5
		$woocommerce_original_symbols = array(
			'AED' => 'د.إ',
			'ARS' => '&#36;',
			'AUD' => '&#36;',
			'BDT' => '&#2547;&nbsp;',
		...
		// as in WooCommerce v2.5.5
		$woocommerce_original_names = array(
		...
		$result_symbols_array = array();
		foreach ( $wcj_currency_symbols as $wcj_currency_symbol_array ) {
			if ( isset( $woocommerce_original_symbols[ $wcj_currency_symbol_array['code'] ] ) ) {
				$wcj_currency_symbol_array['symbol'] = $woocommerce_original_symbols[ $wcj_currency_symbol_array['code'] ];
			}
			if ( isset( $woocommerce_original_names[ $wcj_currency_symbol_array['code'] ] ) ) {
				$wcj_currency_symbol_array['name'] = $woocommerce_original_names[ $wcj_currency_symbol_array['code'] ];
			}
			$result_symbols_array[] = $wcj_currency_symbol_array;
		}
		return $result_symbols_array;
	}
}
