	...
	function wcj_get_reports_standard_ranges() {
		...
		return array(
			'year'        => array(
				...
				'start_gmdate' => gmdate( 'Y-01-01', $current_time ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_month'  => array(
				'title'        => __( 'Last month', 'woocommerce' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( 'first day of previous month', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', strtotime( 'last day of previous month', $current_time ) ),
			),
			'this_month'  => array(
				'title'        => __( 'This month', 'woocommerce' ),
				'start_gmdate' => gmdate( 'Y-m-01', $current_time ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_7_days' => array(
				'title'        => __( 'Last 7 days', 'woocommerce' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-7 days', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
		);
	}
	...
	function wcj_get_reports_custom_ranges() {
		...
		return array(
			'last_14_days'         => array(
				...
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-14 days', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_30_days'         => array(
				'title'        => __( 'Last 30 days', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-30 days', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_3_months'        => array(
				'title'        => __( 'Last 3 months', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-3 months', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_6_months'        => array(
				'title'        => __( 'Last 6 months', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-6 months', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_12_months'       => array(
				'title'        => __( 'Last 12 months', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-12 months', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_24_months'       => array(
				'title'        => __( 'Last 24 months', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-24 months', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'last_36_months'       => array(
				'title'        => __( 'Last 36 months', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-36 months', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
			'same_days_last_month' => array(
				'title'        => __( 'Same days last month', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-01', strtotime( '-1 month', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', strtotime( '-1 month', $current_time ) ),
			),
			'same_days_last_year'  => array(
				'title'        => __( 'Same days last year', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-01', strtotime( '-1 year', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', strtotime( '-1 year', $current_time ) ),
			),
			'last_year'            => array(
				'title'        => __( 'Last year', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-01-01', strtotime( '-1 year', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-12-31', strtotime( '-1 year', $current_time ) ),
			),
			'yesterday'            => array(
				'title'        => __( 'Yesterday', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', strtotime( '-1 day', $current_time ) ),
				'end_gmdate'   => gmdate( 'Y-m-d', strtotime( '-1 day', $current_time ) ),
			),
			'today'                => array(
				'title'        => __( 'Today', 'woocommerce-jetpack' ),
				'start_gmdate' => gmdate( 'Y-m-d', $current_time ),
				'end_gmdate'   => gmdate( 'Y-m-d', $current_time ),
			),
		);
	}
