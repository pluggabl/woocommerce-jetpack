...
class WCJ_Reports_Product_Sales_Daily {
	...
	/*
	 * get_reports_standard_ranges.
	 *
	 * @version 2.8.3
	 * @since   2.8.3
	 * @todo    move to functions
	 */
	function get_reports_standard_ranges() {
		return array(
			'year' => array(
	...
	/*
	 * get_reports_custom_ranges.
	 *
	 * @version 2.8.3
	 * @since   2.8.3
	 * @todo    move to functions
	 */
	function get_reports_custom_ranges() {
		return array(
			'last_14_days' => array(
	...
	function output_report_header() {
		...
		foreach ( array_merge( $this->get_reports_standard_ranges(), $this->get_reports_custom_ranges() ) as $custom_range ) {
			$menu .= '<li><a ' .
