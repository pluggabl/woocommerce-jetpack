...
class Hashids implements HashidsInterface {
	 ...
	 *
	 * @param string $salt Get salt.
	 * @param int    $minHashLength Get minHashLength.
	 * @param string $alphabet Get alphabet.
	 *
	...
	public function encode( ...$numbers ) {
		...
		$ret     = $alphabet[ $numbersHashInt % strlen( $alphabet ) ];
		$lottery = $ret;
		foreach ( $numbers as $i => $number ) {
	 ...
	 *
	 * @param string $str Get string values.
	 *
	 * @return string
	 */
	 ...
	 *
	 * @param string $hash Get decode hase value.
	 *
	 * @return string
	 */
	 ...
	 *
	 * @param string $alphabet Get alphabets.
	 * @param string $salt Get salt.
	 *
	 * @return string
	 */
	 ...
	 *
	 * @param string $input Get input value.
	 * @param string $alphabet Get alphabet.
	 *
	 * @return string
	 */
