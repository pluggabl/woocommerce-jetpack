...
if ( ! class_exists( 'WCJ_Price_By_Country_Local' ) ) :
	...
	class WCJ_Price_By_Country_Local {
		...
		public function create_custom_meta_box( $simple_or_variable, $product_id = 0 ) {
			...
			$current_post_id = ( 0 === $product_id ) ? get_the_ID() : $product_id;
		...
		public function add_hidden_save() {
			...
			echo '<input type="hidden" name="woojetpack_' . wp_kses_post( $meta_box_id ) . '_save_post" value="woojetpack_' . wp_kses_post( $meta_box_id ) . '_save_post">';
		}
